...
parser.add_argument('-d', dest='dataset', type=str, choices=['nyt', 'bio'], help='The dataset name')
...
parser.add_argument('-tn', dest='triple_number', type=int, choices=[1, 2, 3, 4, 5,6,7,8,9],
